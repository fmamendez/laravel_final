...
@section('content')
    <form method="post" action="{{ route('automotores.store') }}" enctype="multipart/form-data">
        ...
        <div class="col-span-6 sm:col-span-3">
            ...
            <select name="titular_id" id="titular" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" autofocus required="">
        ...
        <div class="max-w-sm mt-5">
            ...
            <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">Por favor ingrese la patente del automotor.</p>
        </div>
        <div class="col-span-6 sm:col-span-3 mt-5">
